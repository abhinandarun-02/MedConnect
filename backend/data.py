...
# Initialize an empty dictionary for the diseases
# diseases = {}

# # Iterate through symptom_index and predictions_classes to create the diseases dictionary
# for symptom, index in data_dict['symptom_index'].items():
#     disease_name = data_dict['predictions_classes'][index]
#     diseases[symptom] = {"disease": disease_name}

# Print the resulting diseases dictionary
print(print(len(data_dict['symptom_index'])))
print(len(data_dict['predictions_classes']))